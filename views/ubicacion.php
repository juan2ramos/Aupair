    ...
    <div class="contend-wrapper oktober">
        <section >
            <div class="column-2 big-p">
                Aquí encontraras toda la información sobre nuestros eventos.
            </div>
        ...
        <hr/>
        <div>
            <iframe src="https://mapsengine.google.com/map/u/0/embed?mid=zM4Wh5E4GbI4.kPNhTtMvIpCU" width="900" height="480"></iframe>
        </div>
    </div>
</div>